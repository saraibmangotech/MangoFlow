...
export const edges = [
  { id: 'e1-2', source: '1', target: '2', type: 'smoothstep', label: 'Corporate Guarantee', animated: true, style: { stroke: 'black' } },
  { id: 'e1-3', source: '1', target: '3', type: 'smoothstep', animated: true, style: { stroke: 'black' } },
  { id: 'e1-5', source: '1', target: '5', type: 'smoothstep', animated: true, style: { stroke: 'black' } },
  { id: 'e3-4', source: '3', target: '4', type: 'smoothstep', animated: true, style: { stroke: 'black' } },

  { id: 'e2-2a', source: '2', target: '2a', type: 'smoothstep', animated: true, style: { stroke: 'black' } },
  { id: 'e2-2b', source: '2', target: '2b', type: 'smoothstep', animated: true, style: { stroke: 'black' } },
  { id: 'e2-2c', source: '2', target: '2c', type: 'smoothstep', animated: true, style: { stroke: 'black' } },

  { id: 'e15-12', source: '15', target: '12', type: 'smoothstep', label: '100%', animated: true, style: { stroke: 'black' } },

  { id: 'e10-11', source: '10', target: '11', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e16-11', source: '16', target: '11', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e13-12', source: '13', target: '12', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e5-13', source: '5', target: '13', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e2b-14', source: '2b', target: '14', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e14-11', source: '14', target: '11', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e7-17', source: '17', target: '7', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e6-17', source: '6', target: '17', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e6-18', source: '6', target: '18', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e8-18', source: '18', target: '8', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e9-18', source: '8', target: '9', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
  { id: 'e18-19', source: '18', target: '19', type: 'smoothstep', label: '53%', animated: true, style: { stroke: 'black' } },
];
